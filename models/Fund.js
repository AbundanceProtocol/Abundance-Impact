...
const fundSchema = new mongoose.Schema({
  ...
  tipn_amount: { type: Number, index: true, default: 0 },
  ...
  growth_tipn_amount: { type: Number, default: 0 },
