...
export default function Home({apiKey}) {
  ...
  async function getFeed() {
    ...
    if (typeof feed1 !== 'undefined') {
      ...
      console.log(feed1.casts); // logs information about the feed
              ...
              <div className="flex-row">
                <span className="" datastate="closed" style={{margin: '0 10px 0 0'}}>
                  <a className="" title="" href={`https://warpcast.com/${cast.author.username}`}>
                    <img loading="lazy" src={cast.author.pfp_url} className="" alt={`${cast.author.display_name} avatar`} style={{width: '48px', height: '48px', minWidth: '48px', minHeight: '48px', borderRadius: '24px', border: '1px solid #000'}} />
                  </a>
                </span>
                <div className="flex-col" style={{width: '450px', gap: '0.5rem', alignItems: 'flex-start'}}>
