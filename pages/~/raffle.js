  ...
  return (
    <div className='flex-col' style={{width: 'auto', position: 'relative', padding: '0 0 70px 0'}}>
      ...
      <div title='Cast Actions' className='flex-row' style={{alignItems: 'center', justifyContent: 'center', margin: '8px'}}>
        <p className='' style={{padding: '10px', color: '#fff', fontWeight: '700', fontSize: '20px', userSelect: 'none'}}>Impact 5000 $degen Raffle tickets </p>
      </div>
      <div title='Cast Actions' className='flex-row' style={{alignItems: 'flex-start', justifyContent: 'flex-start', margin: '8px'}}>
        <p className='' style={{padding: '10px', color: '#fff', fontWeight: '700', fontSize: '16px', userSelect: 'none'}}>To participate: multi-tip, auto-tip, or curate content with the /impact $IMPACT Console Cast Action</p>
      </div>
      ...
      <div className='flex-col' style={{margin: '15px 0 10px 0', gap: '0.25rem', alignItems: 'center'}}>
        <div className='flex-row' style={{alignItems: 'center', gap: '0.5rem'}}>
          ...
          <div style={{fontSize: isMobile ? '15px' : '18px', fontWeight:'500', color: '#ace', userSelect: 'none'}}>Get Cast Actions:</div>
        </div>
        <div className='flex-row' style={{gap: '0.5rem', margin: '8px', flexWrap: 'wrap', justifyContent: 'center', alignItems: 'center'}}>

          {isLogged ? (<a className="" title={`$IMPACT Console`} href={`https://farcaster.xyz/~/add-cast-action?name=%24IMPACT+Console&icon=star&actionType=post&postUrl=https%3A%2F%2Fimpact.abundance.id%2Fapi%2Faction%2Fstatus%3Fpoints=IMPACT&description=Curate+Casts+with+the+Impact+App`} target="_blank" rel="noopener noreferrer">
          ...
          {isLogged ? (<a className="" title={`+1 $IMPACT`} href={`https://farcaster.xyz/~/add-cast-action?name=%2B1+%24IMPACT&icon=star&actionType=post&postUrl=https%3A%2Fimpact.abundance.id%2Fapi%2Faction%2Fimpact1%3Fpoints=IMPACT&description=Curate+Casts+with+the+Impact+App`} target="_blank" rel="noopener noreferrer">
            <div className='flex-row cast-act-lt' style={{borderRadius: '8px', padding: '8px 8px', alignItems: 'center', justifyContent: 'center', gap: '0.25rem'}}>
              <FaRegStar size={14} />
