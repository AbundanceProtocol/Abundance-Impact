...
export default function ProfilePage() {
  ...
  const [seasonToggle, setSeasonToggle] = useState("s8"); // update season 5/15
  ...
  async function getUserSearch(getTime, tags, channel, curators, text, shuffle, order, ecosystem, timeSort) {
    ...
    console.log(
      prevSearch.getTime == getTime,
      prevSearch.channel == channel,
      prevSearch.text == text,
      prevSearch.ecosystem == ecosystem,
      prevSearch.getTime == getTime &&
        prevSearch.channel == channel &&
        prevSearch.text == text &&
        prevSearch.ecosystem == ecosystem
    ...
    if (shuffle) {
      ...
      prevSearch.getTime == getTime &&
      prevSearch.channel == channel &&
      prevSearch.curators == curators &&
      prevSearch.text == text &&
      prevSearch.ecosystem == ecosystem &&
      prevSearch.order == order &&
      prevSearch.timeSort == timeSort
    ) {
      setShuffled(false);
      console.log("delay3");
      setDelay(true);
  ...
  const ToggleSwitch = () => {
    ...
    return (
      <div className="flex-col" style={{ justifyContent: "center", alignItems: "center" }}>
        ...
        <div style={{ fontSize: "10px", color: isOn ? "#8ad" : "#68a", margin: "10px 0 0 0" }}>
          {isOn ? "Auto-Funding On" : "Auto-Funding Off"}
        </div>
      </div>
    );
  };
  ...
  const FundPanel = ({ fundName, fundData }) => {
    ...
    } else if (seasonToggle == "s8") {
      totalIndex = fundData?.totalFunds?.findIndex(data => data._id === 8);
      userIndex = fundData?.userFunds?.findIndex(data => data._id === 8);
    } // update season 5/15
      ...
      >
        ...
        <div className="flex-col" style={{ justifyContent: "center", alignItems: "center", gap: "0.25rem" }}>
          <div style={{ fontSize: "16px", fontWeight: "700" }}>
            {fundToggle ? formatNum(totalDegen || 0) || "--" : formatNum(userDegen || 0) || "--"}
          </div>
  ...
  return (
    <div className="flex-col" style={{ width: "auto", position: "relative" }} ref={ref1}>
      ...
      <div
        className="flex-row"
        style={{ height: "30px", alignItems: "center", justifyContent: "flex-start", padding: "20px 0 30px 0" }}
      >
        <div
          className="flex-row"
          style={{
        ...
        >
          ...
          <div className="filter-item-on" style={{ fontWeight: "600", fontSize: isMobile ? "9px" : "10px" }}>
            Studio
          </div>
          <div className="filter-item" style={{ fontWeight: "600", fontSize: isMobile ? "9px" : "10px", padding: "0" }}>
            {">"}
          </div>
          <Link href={`/~/studio/multi-tip`}>
            <div className="filter-item" style={{ fontWeight: "600", fontSize: isMobile ? "9px" : "10px" }}>
              multi-tip
            </div>
          </Link>
      ...
      <div className="flex-row" style={{ justifyContent: "center" }}>
        ...
        >
          ...
          >
            <div onClick={() => document.getElementById("score").scrollIntoView({ behavior: "smooth" })}>
              <div
        ...
        >
          ...
          >
            <div onClick={() => document.getElementById("fund").scrollIntoView({ behavior: "smooth" })}>
              <div
                className="flex-row cast-act-lt"
                style={{
                  borderRadius: "8px",
        ...
        >
          ...
          >
            <div onClick={() => document.getElementById("curation").scrollIntoView({ behavior: "smooth" })}>
              <div
                className="flex-row cast-act-lt"
                style={{
                  borderRadius: "8px",
        ...
        >
          ...
          >
            <div onClick={() => document.getElementById("multitip").scrollIntoView({ behavior: "smooth" })}>
              <div
                className="flex-row cast-act-lt"
                style={{
                  borderRadius: "8px",
        ...
        >
            ...
            >
              ...
              <FaAngleDown
                ...
                style={{
                  ...
                  transform: display.what ? "rotate(180deg)" : "rotate(0deg)",
          ...
          {display.what && (
            ...
            >
              ...
              <div className="flex-row page-t3" style={{ fontSize: isMobile ? "15px" : "17px" }}>
                We want everyone on Farcaster (and beyond) to prosper simply by making meaning contributions in their
                community & the world. /impact is the first step in that journey.
              </div>

              <div className="flex-row page-t3" style={{ fontSize: isMobile ? "15px" : "17px" }}>
                We're creating an Impact Market where curators are rewarded for proactively finding and evaluating
                impactful content and work on Farcaster.
              </div>
              ...
              <div className="flex-row page-t3" style={{ fontSize: isMobile ? "15px" : "17px" }}>
                As the ecosystem grows a feedback loop will start forming between the impact created and the Network
                Economy.
              </div>

              <div
                className="flex-row page-t3"
                style={{ fontSize: isMobile ? "15px" : "17px", display: "inline-block" }}
              >
                Read about the{" "}
                <Link href="https://paragraph.xyz/@abundance/the-secret-impact-alpha-master-plan" target="_blank">
        ...
        >
          ...
          >
            ...
            >
              ...
              <FaAngleDown
                ...
                style={{
                  margin: "5px 15px 5px 5px",
                  transform: display.how ? "rotate(180deg)" : "rotate(0deg)",
                  transition: "transform 0.3s ease"
                }}
              />
            </div>
          ...
          {display.how && (
            ...
            >
                ...
                <ItemWrap crsr={true}>
                  <Item
                    {...{
                      icon: IoMdTrophy,
                      text: "Impact Score",
                      description: `/impact is currently running Daily Impact Rewards`
                    }}
                  />
                  <Item
                    {...{
                ...
                <ItemWrap crsr={true}>
                  <Item
                    {...{
                      icon: Medal,
                      text: "Curate",
                      description: `You get a daily allowance of $IMPACT points`
                    }}
                  />
                  <Item
                    {...{
              ...
              <div
                onClick={() => document.getElementById("autoFund").scrollIntoView({ behavior: "smooth" })}
                style={{ width: "100%" }}
              >
                <ItemWrap crsr={true}>
                  <Item
              ...
              <div
                onClick={() => document.getElementById("invites").scrollIntoView({ behavior: "smooth" })}
                style={{ width: "100%" }}
              >
                <ItemWrap crsr={true}>
                  <Item
                    {...{
                      icon: FaUsers,
                      text: "Invite",
                      description: "Invite your friends to use Impact Alpha - win rewards. "
                    }}
                  />
                  <Item
                    {...{
          ...
          >
            ...
            >
              ...
              <FaAngleDown
                ...
                style={{
                  margin: "5px 15px 5px 5px",
                  transform: display.score ? "rotate(180deg)" : "rotate(0deg)",
                  transition: "transform 0.3s ease"
                }}
              />
            </div>
              ...
              {loading.score ? (
                ...
                >
                  <div
                    ...
                    style={{
                      minWidth: isMobile ? "155px" : "120px",
                      width: isMobile ? "100%" : "50%",
                      padding: isMobile ? "22px 12px 12px 12px" : "10px",
                      flexGrow: 1
                    }}
                  >
                    <div style={{ width: "167px", position: "relative" }}>
                      <div
                        style={{
                          mask: `linear-gradient(rgba(0, 0, 0, 0) 0px, rgba(0, 0, 0, 0) 0px) content-box intersect, conic-gradient(rgb(0, 0, 0) ${userScore?.impactRank *
                            2.7 || 0}deg, rgba(0, 0, 0, 0) 0deg)`,
                          transform: "rotate(-135deg)",
                          width: "100%",
                          transition: "mask-image 0.3s ease"
                        }}
                        className="top-layer absolute blu-std p-5 rounded-full aspect-square"
                      ></div>
                      <div
                        className="blu-std-drk p-5 rounded-full aspect-square"
                        style={{
                          mask:
                            "linear-gradient(rgba(0, 0, 0, 0) 0px, rgba(0, 0, 0, 0) 0px) content-box intersect, conic-gradient(rgb(0, 0, 0) 270deg, rgba(0, 0, 0, 0) 0deg)",
                          transform: "rotate(-135deg)",
                          width: "100%"
                        }}
                      ></div>
                      <div className="absolute flex flex-col justify-c items-c text-c">
                        {scoreLoading ? (
                          ...
                          <div>
                            ...
                            <div style={{ fontSize: "13px" }}>Top {userScore?.impactRank || 0}%</div>
                          </div>
                        )}
                      </div>
                    </div>
                    ...
                    >
                      <div style={{ fontSize: "18px", fontWeight: "600", margin: "-10px 0 3px 0" }}>
                        {scoreTime == "all" || scoreTime == "30d" ? "Impact " : "Reward "}Score
                      </div>
                    </div>

                    <div
                      className="flex-row text-c"
                      style={{
                        justifyContent: "center",
                        alignItems: "center",
                        gap: "0.75rem",
                        ...
                        backgroundColor: "#00224466"
                      }}
                    >
                      <div style={{ fontSize: isMobile ? "12px" : "12px", fontWeight: "400" }}>
                        {scoreTime == "all" || scoreTime == "30d"
                          ? "Impact Score = Creator Score + Curator Score + Contributor Score"
                          : "Reward Score = Curator Score + Contributor Score + Invite Score"}{" "}
                      </div>
                    </div>
                    ...
                    <div
                      ...
                      style={{ gap: isMobile ? "0.5rem" : "0.25rem", margin: isMobile ? "5px 0 0 0" : "30px 0 0 0" }}
                    >
                      <div
                        className="flex-row"
                        style={{ height: "30px", alignItems: "center", justifyContent: "center", padding: "0px 0" }}
                      >
                        <div
                          className="flex-row"
                          style={{
                        ...
                        >
                          <div
                            ...
                            style={{ fontWeight: "600", fontSize: isMobile ? "9px" : "10px" }}
                          >
                            REWARD
                          </div>

                          <div
                            className={scoreTime == "24h" ? "filter-item-on" : "filter-item"}
                            onClick={() => {
                              updateScore("24h");
                            }}
                          >
                          ...
                          <div
                            className={scoreTime == "3d" ? "filter-item-on" : "filter-item"}
                            onClick={() => {
                              updateScore("3d");
                            }}
                          >
                          ...
                          <div
                            className={scoreTime == "7d" ? "filter-item-on" : "filter-item"}
                            onClick={() => {
                              updateScore("7d");
                            }}
                          >
                      ...
                      >
                        ...
                        >
                          ...
                          <div
                            className={scoreTime == "30d" ? "filter-item-on" : "filter-item"}
                            onClick={() => {
                              updateScore("30d");
                            }}
                          >
                          ...
                          <div
                            className={scoreTime == "all" ? "filter-item-on" : "filter-item"}
                            onClick={() => {
                              updateScore("all");
                            }}
                          >
                  ...
                  >
                    <div
                      className="flex-col btn-select blu-lt"
                      style={{
                        minWidth: isMobile ? "125px" : "120px",
                    ...
                    >
                      <div style={{ width: "127px", position: "relative" }}>
                        <div
                          style={{
                            mask: `linear-gradient(rgba(0, 0, 0, 0) 0px, rgba(0, 0, 0, 0) 0px) content-box intersect, conic-gradient(rgb(0, 0, 0) ${
                              scoreTime == "all" || scoreTime == "30d" ? userScore?.creatorRank * 2.7 || 0 : 0
                            }deg, rgba(0, 0, 0, 0) 0deg)`,
                            transform: "rotate(-135deg)",
                            width: "100%"
                          }}
                          className="top-layer absolute blu-std p-5 rounded-full aspect-square"
                          ...
                          {scoreLoading ? (
                            ...
                            <div>
                              <div style={{ fontSize: "24px", fontWeight: "700" }}>
                                {scoreTime == "all" || scoreTime == "30d" ? userScore?.creatorScore / 20 || 0 : "--"}
                              </div>
                              <div style={{ fontSize: "10px" }}>
                                Top {scoreTime == "all" || scoreTime == "30d" ? userScore?.creatorRank || 0 : 0}%
                              </div>
                            </div>
                          )}
                        </div>
                    ...
                    >
                      <div style={{ width: "127px", position: "relative" }}>
                        <div
                          style={{
                            mask: `linear-gradient(rgba(0, 0, 0, 0) 0px, rgba(0, 0, 0, 0) 0px) content-box intersect, conic-gradient(rgb(0, 0, 0) ${userScore?.curatorRank *
                              2.7 || 0}deg, rgba(0, 0, 0, 0) 0deg)`,
                            transform: "rotate(-135deg)",
                            width: "100%"
                          }}
                        ...
                        <div className="absolute flex flex-col justify-c items-c text-c">
                          {scoreLoading ? (
                            ...
                            <div>
                              <div style={{ fontSize: "24px", fontWeight: "700" }}>
                                {userScore?.curatorScore / 100 || 0}
                              </div>
                              <div style={{ fontSize: "10px" }}>Top {userScore?.curatorRank || 0}%</div>
                            </div>
                          )}
                        </div>
                      </div>
                    ...
                    >
                      <div style={{ width: "127px", position: "relative" }}>
                        <div
                          style={{
                            mask: `linear-gradient(rgba(0, 0, 0, 0) 0px, rgba(0, 0, 0, 0) 0px) content-box intersect, conic-gradient(rgb(0, 0, 0) ${userScore?.contributorRank *
                              2.7 || 0}deg, rgba(0, 0, 0, 0) 0deg)`,
                            transform: "rotate(-135deg)",
                            width: "100%"
                          }}
                        ...
                        <div className="absolute flex flex-col justify-c items-c text-c">
                          {scoreLoading ? (
                            ...
                            <div>
                              <div style={{ fontSize: "24px", fontWeight: "700" }}>
                                {userScore?.contributorScore || 0}
                              </div>
                              <div style={{ fontSize: "10px" }}>Top {userScore?.contributorRank || 0}%</div>
                            </div>
                          )}
                        </div>
                      </div>
                    ...
                    >
                      <div style={{ width: "127px", position: "relative" }}>
                        <div
                          style={{
                            mask: `linear-gradient(rgba(0, 0, 0, 0) 0px, rgba(0, 0, 0, 0) 0px) content-box intersect, conic-gradient(rgb(0, 0, 0) ${
                              scoreTime == "all" || scoreTime == "30d" ? 0 : userScore?.inviteRank * 2.7 || 0
                            }deg, rgba(0, 0, 0, 0) 0deg)`,
                            transform: "rotate(-135deg)",
                            width: "100%"
                          }}
                        ...
                        <div className="absolute flex flex-col justify-c items-c text-c">
                          {scoreLoading ? (
                            ...
                            <div>
                              <div style={{ fontSize: "24px", fontWeight: "700" }}>
                                {scoreTime == "all" || scoreTime == "30d" ? "--" : userScore?.inviteScore || 0}
                              </div>
                              <div style={{ fontSize: "10px" }}>Top {userScore?.inviteRank || 0}%</div>
                            </div>
                          )}
                        </div>
                      </div>
      ...
      <div style={{ padding: "0px 4px 0px 4px", width: feedMax }}>
        ...
        >
          ...
          >
            Note: Daily Rewards accumulate for up to 4 days. Rewards expire after 4 days if unclaimed - they are then
            moved to the Creator Fund
          </div>
          <div
            className="flex-row"
            style={{
          ...
          >
            Daily Rewards are accumulated throughout the Season. They are then airdropped to your wallet after Claim
            Day.
          </div>
        </div>
      </div>
      ...
      <div style={{ padding: "0px 4px 0px 4px", width: feedMax }}>
        ...
        >
          ...
          >
            ...
            >
              ...
              <FaAngleDown
                ...
                style={{
                  margin: "5px 15px 5px 5px",
                  transform: display.fund ? "rotate(180deg)" : "rotate(0deg)",
                  transition: "transform 0.3s ease"
                }}
              />
            </div>
          ...
          <div className={isMobile ? "flex-col" : "flex-row"} style={{ justifyContent: "center", gap: "0.5rem" }}>
            <div
              className="flex-row"
              style={{ height: "30px", alignItems: "center", justifyContent: "center", padding: "20px 0 0 0" }}
            >
              <div
                className="flex-row"
                style={{
              ...
              >
                <div
                  className={seasonToggle == "all" ? "filter-item-on" : "filter-item"}
                  onClick={() => {
                    setSeasonToggle("all");
                  }}
                ...
                <div
                  className={seasonToggle == "s1" ? "filter-item-on" : "filter-item"}
                  onClick={() => {
                    setSeasonToggle("s1");
                  }}
                  style={{ fontSize: "12px", fontWeight: "600" }}
                ...
                <div
                  className={seasonToggle == "s2" ? "filter-item-on" : "filter-item"}
                  onClick={() => {
                    setSeasonToggle("s2");
                  }}
                  style={{ fontSize: "12px", fontWeight: "600" }}
                ...
                <div
                  className={seasonToggle == "s3" ? "filter-item-on" : "filter-item"}
                  onClick={() => {
                    setSeasonToggle("s3");
                  }}
                  style={{ fontSize: "12px", fontWeight: "600" }}
                ...
                <div
                  className={seasonToggle == "s4" ? "filter-item-on" : "filter-item"}
                  onClick={() => {
                    setSeasonToggle("s4");
                  }}
                  style={{ fontSize: "12px", fontWeight: "600" }}
                ...
                <div
                  className={seasonToggle == "s5" ? "filter-item-on" : "filter-item"}
                  onClick={() => {
                    setSeasonToggle("s5");
                  }}
                  style={{ fontSize: "12px", fontWeight: "600" }}
                ...
                <div
                  className={seasonToggle == "s6" ? "filter-item-on" : "filter-item"}
                  onClick={() => {
                    setSeasonToggle("s6");
                  }}
                  style={{ fontSize: "12px", fontWeight: "600" }}
                ...
                <div
                  className={seasonToggle == "s7" ? "filter-item-on" : "filter-item"}
                  onClick={() => {
                    setSeasonToggle("s7");
                  }}
                  style={{ fontSize: "12px", fontWeight: "600" }}
                ...
                <div
                  className={seasonToggle == "s8" ? "filter-item-on" : "filter-item"}
                  onClick={() => {
                    setSeasonToggle("s8");
                  }}
                  style={{ fontSize: "12px", fontWeight: "600" }}
            ...
            >
              ...
              >
                <div
                  className={fundToggle == true ? "filter-item-on" : "filter-item"}
                  onClick={() => {
                    setFundToggle(true);
                  }}
                  style={{ fontSize: "12px", fontWeight: "600" }}
                ...
                <div
                  className={fundToggle == false ? "filter-item-on" : "filter-item"}
                  onClick={() => {
                    setFundToggle(false);
                  }}
                  style={{ fontSize: "12px", fontWeight: "600" }}
          ...
          {display.fund && (
            <>
              ...
              >
                ...
                >
                  How it works: Auto-Fund automatically distributes your leftover $degen allowances before allowances
                  reset to Impact Fund based on your preference.
                </div>
                ...
                <ItemWrap bgColor={"#002244ee"} brdr={"0px"}>
                  <Item
                    {...{
                      icon: Impact,
                      text: "Creator Fund",
                      description: `Rewards builders & creators on Farcaster based on their contribution to the ecosystem (impact = profit). 90% of funds go to creators and 10% to curators`
                    }}
                  />
                </ItemWrap>
                ...
                <ItemWrap bgColor={"#002244ee"} brdr={"0px"}>
                  <Item
                    {...{
                      icon: IoIosRocket,
                      text: "Growth Fund",
                      description: `Adds incentives and rewards to those who curate, contribute and spread the word about Impact Alpha while the system gets to the scale where it can operate self-sustainably`
                    }}
                  />
                </ItemWrap>
              </div>
          ...
          >
            ...
            >
              ...
              <FaAngleDown
                ...
                style={{
                  margin: "5px 15px 5px 5px",
                  transform: display.autoFund ? "rotate(180deg)" : "rotate(0deg)",
                  transition: "transform 0.3s ease"
                }}
              />
            </div>
          ...
          {display.autoFund && (
            <>
              ...
              >
                ...
                >
                  <div
                    ...
                    style={{
                      ...
                      color: userFunding?.active_cron && userFunding?.currencies?.includes("$DEGEN") ? "#000" : "#cde",
                      height: "33px"
                    }}
                    onClick={() => {
                  ...
                  <div
                    ...
                    style={{
                      minWidth: isMobile ? "30%" : "30%",
                      color: userFunding?.active_cron && userFunding?.currencies?.includes("$TIPN") ? "#000" : "#cde",
                      height: "33px"
                    }}
                    onClick={() => {
                ...
                {userFunding?.creator_fund > 0 && (
                  <div className="flex-row" style={{ width: "100%", justifyContent: "center", flexWrap: "wrap" }}>
                            ...
                            >
                              {curator?.pfp && (
                                <img
                                  ...
                                  width={20}
                                  height={20}
                                  style={{ borderRadius: "80px", border: "2px solid #eee", backgroundColor: "#8363ca" }}
                                />
                              )}
                              <div
                                style={{
                ...
                {userFunding?.creator_fund > 0 && (
                  <div
                    className="flex-col"
                    style={{ height: "30px", alignItems: "center", justifyContent: "center", padding: "40px 0 30px 0" }}
                  >
                    <div
                      className="flex-row"
                      style={{
          ...
          >
            ...
            >
              ...
              <FaAngleDown
                ...
                style={{
                  margin: "5px 15px 5px 5px",
                  transform: display.curation ? "rotate(180deg)" : "rotate(0deg)",
                  transition: "transform 0.3s ease"
                }}
              />
            </div>
                ...
                {searchSelect == "Curation" && (
                  <div
                    ...
                    style={{
                      ...
                      marginTop: "15px",
                      marginBottom: "30px",
                      gap: isMobile ? "0.15rem" : "0.15rem",
                      flexWrap: "wrap"
                    }}
                  >
                    <div
                      className="flex-row"
                      style={{ height: "30px", alignItems: "center", justifyContent: "center", padding: "20px 0" }}
                    >
                      <div
                        className="flex-row"
                        style={{
                      ...
                      >
                        <div className="filter-desc" style={{ fontWeight: "600", fontSize: isMobile ? "9px" : "10px" }}>
                          SORT
                        </div>
                  ...
                  <div className={timeframe == '3d' ? 'filter-item-on' : 'filter-item'} onClick={() => {updateTime('3d')}}>3d</div> */}
                        <div
                          className={sortBy == "down" ? "filter-item-on" : "filter-item"}
                          style={{ padding: "2px 6px 0px 6px" }}
                          onClick={() => {
                            updateOrder("down");
                          }}
                        >
                        ...
                        <div
                          className={sortBy == "up" ? "filter-item-on" : "filter-item"}
                          style={{ padding: "2px 6px 0px 6px" }}
                          onClick={() => {
                            updateOrder("up");
                          }}
                        ...
                        <div
                          className={sortBy == "shuffle" ? "filter-item-on" : "filter-item"}
                          style={{ padding: "2px 6px 0px 6px" }}
                          onClick={() => {
                            updateOrder("shuffle");
                          }}
                        ...
                        <div
                          className={sortBy == "clock-forward" ? "filter-item-on" : "filter-item"}
                          style={{ padding: "2px 6px 0px 6px" }}
                          onClick={() => {
                            updateOrder("clock-forward");
                          }}
                        >
                          <ClockForward size={12} />
                        </div>
                        <div
                          className={sortBy == "clock-back" ? "filter-item-on" : "filter-item"}
                          style={{ padding: "2px 6px 0px 6px" }}
                          onClick={() => {
                            updateOrder("clock-back");
                          }}
                        >
                          <ClockBack size={12} />
                        </div>
                    ...
                    >
                      ...
                      >
                        ...
                        <div
                          className={timeframe == "24h" ? "filter-item-on" : "filter-item"}
                          onClick={() => {
                            updateTime("24h");
                          }}
                        >
                        ...
                        <div
                          className={timeframe == "3d" ? "filter-item-on" : "filter-item"}
                          onClick={() => {
                            updateTime("3d");
                          }}
                        >
                        ...
                        <div
                          className={timeframe == "7d" ? "filter-item-on" : "filter-item"}
                          onClick={() => {
                            updateTime("7d");
                          }}
                        >
                        ...
                        <div
                          className={timeframe == "30d" ? "filter-item-on" : "filter-item"}
                          onClick={() => {
                            updateTime("30d");
                          }}
                        >
                        ...
                        <div
                          className={timeframe == "all" ? "filter-item-on" : "filter-item"}
                          onClick={() => {
                            updateTime("all");
                          }}
                        >
                    ...
                    userFeed.map((cast, index) => (
                      <Cast
                        {...{
                          ...
                          updateCast,
                          openImagePopup,
                          ecosystem: eco?.ecosystem_points_name,
          ...
          >
            ...
            >
              ...
              <FaAngleDown
                ...
                style={{
                  margin: "5px 15px 5px 5px",
                  transform: display.invites ? "rotate(180deg)" : "rotate(0deg)",
                  transition: "transform 0.3s ease"
                }}
              />
            </div>
                      ...
                      invites.map((invite, index) => {
                        return (
                          <Link
                            key={index}
                            target="_blank"
                            href={`https://farcaster.xyz/${invite.username}`}
                          ...
                          >
                            <div className="btn-blu" style={{ gap: "1.5rem", minWidth: isMobile ? "290px" : "250px" }}>
                              ...
                              >
                                ...
                                <div style={{ fontSize: isMobile ? "16px" : "15px", fontWeight: "400", color: "#eff" }}>
                                  @{invite?.username}
                                </div>
                              </div>
                              ...
                              {invite?.score >= 0 && (
                                <div
                                  className="flex-row"
                                  style={{ padding: "10px 0 0 0", alignItems: "flex-end", gap: "0.25rem" }}
                                >
                                  <div
                                    style={{ fontSize: isMobile ? "12px" : "13px", fontWeight: "600", color: "#abc" }}
                                  >
                                    Impact Score:
                                  </div>
                                  <div
                                ...
                                >
                                  ...
                                  <div
                                    style={{
                                      fontSize: isMobile ? "11px" : "12px",
                                      fontWeight: "400",
                                      color: invite?.staked > 0 ? "#0c0" : "#abc"
                                    }}
                                  >
                                    {invite?.staked ? invite?.staked + " $impact" : 0}
                                  </div>
                                </div>
                              )}
                                ...
                                >
                                  ...
                                  <div
                                    style={{
                                      fontSize: isMobile ? "11px" : "12px",
                                      fontWeight: "400",
                                      color: invite?.autoFund > 0 ? "#0c0" : "#abc"
                                    }}
                                  >
                                    {invite?.autoFund ? invite?.autoFund + " $degen" : 0}
                                  </div>
                                </div>
                              )}
                            </div>
          ...
          >
            ...
            >
              ...
              <FaAngleDown
                ...
                style={{
                  margin: "5px 15px 5px 5px",
                  transform: display.multitip ? "rotate(180deg)" : "rotate(0deg)",
                  transition: "transform 0.3s ease"
                }}
              />
            </div>
                    ...
                    {multitips?.length > 0 ? (
                      multitips.map((multitip, index) => {
                        ...
                        return (
                          <Link
                            className="btn-blu"
                            key={index}
                            href={`/~/studio/tip/${multitip?._id}`}
                            style={{ minWidth: isMobile ? "190px" : "190px" }}
                          >
                            <div className="" style={{ gap: "1.5rem" }}>
                              <div
                                className="flex-row"
                                style={{ gap: "1rem", paddingBottom: "0px", justifyContent: "flex-end" }}
                              >
                                <div className="flex-row" style={{ flexWrap: "wrap" }}>
                                  {multitip?.text && (
                                    <div
                                      className="curator-button-off"
                                      style={{ fontSize: isMobile ? "8px" : "9px", border: "0px" }}
                                    >
                                      TIP: {multitip?.text}
                                    </div>
                                  )}
                                  {multitip?.createdAt && (
                                    <div
                                      ...
                                      style={{ fontSize: isMobile ? "8px" : "9px", border: "0px" }}
                                    >
                                      {timePassed(multitip?.createdAt)}
                                    </div>
                                  )}
                                  {multitip && showButton && (
                                    <div
                                      className="curator-button"
                                      style={{ fontSize: isMobile ? "8px" : "9px", border: "1px solid #999" }}
                                      onClick={event => {
                                        shareFrame(event, multitip);
                                      }}
                                    >
                                      <FiShare size={9} color={"#eff"} />
                                    </div>
                                  )}
                                </div>
                              </div>
                              <div style={{ fontSize: isMobile ? "17px" : "18px", fontWeight: "500", color: "#eff" }}>
                                {multitip?.text && (
                                  <div
                                    className="flex-row"
                                    style={{
                                  ...
                                  >
                                    CURATOR:{" "}
                                    {multitip?.curators?.length > 0 &&
                                      multitip?.curators.map((curator, index) => (
                                        <Link
                                          key={index}
                                          href={`/~/ecosystems/${curator?.handle || "abundance"}/curators/${
                                            curator?.username
                                          }`}
                                        >
                                          <div className="filter-item" style={{ fontSize: isMobile ? "11px" : "12px" }}>
                                            @{curator?.username}
                                          </div>
                                        </Link>
                                      ))}
                      ...
                      <>
                        {!loaded ? (
                          ...
                          <div style={{ fontSize: "20px", color: "#def" }}>No tips found</div>
                        )}
                      </>
                    )}
                  </div>
      ...
      {impactFunds?.userFunds &&
        (impactFunds?.userFunds[0]?.creator_degen > 0 || impactFunds?.userFunds[0]?.creator_ham > 0) && (
          <div style={{ padding: "0px 4px 0px 4px", width: feedMax }}>
            <div
              id="distribution"
              style={{
              ...
              >
                ...
                >
                  ...
                  <FaAngleDown
                    ...
                    style={{
                      margin: "5px 15px 5px 5px",
                      transform: display.distribution ? "rotate(180deg)" : "rotate(0deg)",
                      transition: "transform 0.3s ease"
                    }}
                  />
                </div>
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              <div
                                style={{ fontSize: "15px", fontWeight: "700", margin: "0 0 5px 0", color: "#44aaff" }}
                              >
                                Ecosystem-wide
                              </div>
                            </div>
                            ...
                            >
                              ...
                              >
                                <div style={{ fontSize: "16px", fontWeight: "700" }}>
                                  {funds?.fundDegen > 0 ? formatNum(funds?.fundDegen || 0) : "--"}
                                </div>
                                <div style={{ fontSize: "9px", fontWeight: "400", color: "#8cf" }}>$DEGEN</div>
                              </div>
                  ...
                  <div style={{fontSize: '9px', fontWeight: '400', color: '#8cf'}}>$HAM</div>
                          ...
                          >
                            ...
                            >
                              ...
                              >
                                <div style={{ fontSize: "16px", fontWeight: "700" }}>
                                  {funds?.curatorDegen > 0 ? formatNum(funds?.curatorDegen || 0) : "--"}
                                </div>
                                <div style={{ fontSize: "9px", fontWeight: "400", color: "#8cf" }}>$DEGEN</div>
                              </div>
                    ...
                    <div style={{fontSize: '9px', fontWeight: '400', color: '#8cf'}}>$HAM</div>
                        ...
                        {distribution?.curatorDataset?.length > 0 && (
                          <div
                            className="flex-row"
                            style={{
                              alignItems: "center",
                        ...
                        {distribution?.curatorDataset?.length > 0 ? (
                          distribution?.curatorDataset?.map((curator, index) => {
                            return (
                              <div
                                key={index}
                                className="flex-row"
                              ...
                              >
                                ...
                                >
                                  ...
                                  >
                                    <Link
                                      className="fc-lnk"
                                      href={`/~/ecosystems/${ecoData?.ecosystem_handle || "abundance"}/curators/${
                                        curator?.username
                                      }`}
                                    >
                                      @{curator?.username}
                          ...
                          <>
                            {distLoading ? (
                              ...
                              <div style={{ fontSize: "20px", color: "#def", textAlign: "center", padding: "0px" }}>
                                &nbsp;
                              </div>
                            )}
                          </>
                        ...
                        {distribution?.creatorDataset?.length > 0 && (
                          <div
                            className="flex-row"
                            style={{
                              alignItems: "center",
                        ...
                        {distribution?.creatorDataset?.length > 0 ? (
                          distribution?.creatorDataset?.map((creator, index) => {
                            return (
                              <div
                                key={index}
                                className="flex-row"
                              ...
                              >
                                ...
                                >
                                  ...
                                  >
                                    <Link
                                      className="fc-lnk"
                                      href={`/~/ecosystems/${ecoData?.ecosystem_handle || "abundance"}/creators/${
                                        creator?.username
                                      }`}
                                    >
                                      @{creator?.username}
                          ...
                          <>
                            {distLoading ? (
                              ...
                              <div style={{ fontSize: "20px", color: "#def", textAlign: "center", padding: "20px" }}>
                                no creators found
                              </div>
                            )}
                          </>
                        ...
                        {distribution?.creatorDataset?.length > 0 && (
                          ...
                          >
                            ...
                            >
                              {distribution?.totalEcoCreators > 0
                                ? distribution?.totalEcoCreators + " ecosystem creators"
                                : distribution?.totalCreators > 20 && distribution?.totalCreators + " total creators"}
                            </div>
                          </div>
                        )}
                      </div>
            ...
            >
              <div
                style={{
                  ...
                  backgroundColor: adminTest ? "#246" : "#ace",
                  color: adminTest ? "#ace" : "#246",
                  cursor: "pointer"
                }}
                onClick={() => setAdminTest(false)}
              >
                Impact 1.0
              </div>
              <div
                style={{
                  padding: "5px",
                  border: "1px solid #777",
                  backgroundColor: adminTest ? "#ace" : "#246",
                  color: adminTest ? "#246" : "#ace",
                  cursor: "pointer"
                }}
                onClick={() => setAdminTest(true)}
              >
                Impact 2.0
              </div>
