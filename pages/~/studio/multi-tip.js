...
export default function MultiTip() {
  ...
  async function setupEcosystem(target) {
    ...
    console.log(frameEcosystem?.url, frameTime?.url, fid, frameEcosystem?.eco, frameCurators?.url)
  ...
  return (
    <div name="feed" style={{ width: "auto", maxWidth: "620px" }} ref={ref}>
      ...
      <div style={{ padding: "58px 0 0 0", width: feedMax }}></div>
      ...
      {/* <div
        className="flex-row"
        style={{ margin: "33px 3px 8px 3px", gap: "1rem" }}
      >
        <Description
          {...{ show: true, text: "Ecosystem:", padding: "0 0 0 10px" }}
        />
      </div> */}
      ...
      {/* <Dropdown
        {...{
          key: 0,
          name: 0,
          value: frameTime.condition,
          setupEcosystem,
          target: 0,
          conditions: ecosystemOptions,
          cancel: false,
          isSet: frameEcosystem.isSet,
          setCondition: setEcosystem,
          state: true,
        }}
      /> */}
      ...
      >
        <Description
          {...{ show: true, text: "Curators:", padding: "0 0 0 10px" }}
        />
      </div>
      ...
      <Dropdown
        {...{
          key: 1,
          name: 0,
          value: frameCurators.condition,
          setupEcosystem,
          target: 0,
          conditions: curatorOptions,
          cancel: false,
          isSet: frameCurators.isSet,
          setCondition: setCurators,
          state: frameCurators.state,
        }}
      />
      ...
      >
        <Description
          {...{ show: true, text: "Timeframe:", padding: "0 0 0 10px" }}
        />
      </div>
      ...
      <Dropdown
        {...{
          ...
          cancel: false,
          isSet: frameTime.isSet,
          setCondition: setTimeframe,
          state: frameTime.state,
        }}
      />
      ...
      >
        <Description
          {...{ show: true, text: "Channel:", padding: "0 0 0 10px" }}
        />
      </div>
      ...
      <Dropdown
        {...{
          ...
          setupEcosystem,
          target: 0,
          conditions: channelOptions,
          cancel: false,
          isSet: "working",
          setCondition: updateChannel,
          state: true,
        }}
      />
