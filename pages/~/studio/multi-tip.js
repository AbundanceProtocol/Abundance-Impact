...
export default function MultiTip() {
  ...
  <div name='feed' style={{width: 'auto', maxWidth: '620px'}} ref={ref}>
    ...
    <img src={`${baseURL}/api/multi-tip/frame?${qs.stringify({ status: 'off', curators: frameCurators?.url, points: '$IMPACT', needLogin: false, time: frameTime?.url, channel: selectedChannel})}`} style={{width: '100%', height: 'auto', maxWidth: '400px', minWidth: 'auto', minHeight: 'auto', borderRadius: '15px', aspectRatio: '1 / 1', border: '3px solid #abc'}} /></div>
