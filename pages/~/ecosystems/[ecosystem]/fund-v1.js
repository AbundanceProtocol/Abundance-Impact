...
export default function Tips({ecosystem, referrer, id}) {
  ...
  const shareText = `Auto-fund farcasters supprting the LA wildfire relief effort with your daily (remaining) $degen & $ham thru /impact's @impactfund 👇`
  ...
  const initFrame = 
    {
      version: "vNext",
      title: "Multi-Tip",
      image: `${baseURL}/api/frames/fund/frame?${qs.stringify({ id })}`,
      ...
      buttons: [
        {
          ...
          title: "Auto-Fund",
          action_type: "post",
          target: `${baseURL}/api/frames/fund/auto-fund`
        },
        {
          index: 2,
          title: "Share",
        ...
        },
        {
          ...
          title: "Login /impact",
          action_type: "link",
          target: `${baseURL}?${qs.stringify({referrer: referrer || null})}`
        },
        // {
        //   index: 3,
        //   title: "Auto-tip >",
  ...
  useEffect(() => {
    ...
    updatedFrameData.buttons[0].target = `${baseURL}/api/frames/fund/auto-fund`
    ...
    updatedFrameData.image = `${baseURL}/api/frames/fund/frame?${qs.stringify({ id })}`
  ...
  return (
    ...
    {queryData && (
      <Head>
        <title>Auto-Fund | Impact App</title>
        ...
        <meta property='og:image' content={`${baseURL}/api/frames/fund/frame?${qs.stringify({ id })}`} />
        <meta property="fc:frame" content="vNext" />
        <meta property="fc:frame:image" content={`${baseURL}/api/frames/fund/frame?${qs.stringify({ id })}`} />
        <meta property="fc:frame:image:aspect_ratio" content="1.91:1" />
        <meta property="fc:frame:button:1" content='Auto-Fund' />
        <meta property="fc:frame:button:1:action" content="post" />
        <meta property="fc:frame:button:1:target" content={`${baseURL}/api/frames/fund/auto-fund`} />
        ...
        <meta property="fc:frame:button:3:target" content={`${baseURL}?${qs.stringify({ referrer })}`} />
