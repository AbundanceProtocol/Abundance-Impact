...
export default function Tips({referrer}) {
  ...
  const initFrame = 
    {
      version: "vNext",
      title: "Impact Fund",
      image: `${baseURL}/api/frames/subscribe/fund-dash?${qs.stringify({ fid: referrer })}`,
      ...
      buttons: [
        {
          ...
          title: "Boost",
          action_type: "post",
          target: `${baseURL}/api/frames/subscribe/fund?fund=boost`
        },
        {
          index: 2,
          title: "Validate",
          action_type: "post",
          target: `${baseURL}/api/frames/subscribe/fund?fund=validate`
        },
        // {
        //   index: 3,
        //   title: "Accelerated",
        //   action_type: "post",
        //   target: `${baseURL}/api/frames/subscribe/fund?fund=accelerated`
        // },
        {
          index: 3,
          title: "Login /impact",
  ...
  useEffect(() => {
    ...
    updatedFrameData.image = `${baseURL}/api/frames/subscribe/fund-dash?${qs.stringify({ fid: referrer })}`
  ...
  return (
    ...
    {queryData && (
      <Head>
        ...
        <meta property='og:image' content={`${baseURL}/api/frames/subscribe/fund-dash?${qs.stringify({ fid: referrer })}`} />
        <meta property="fc:frame" content="vNext" />
        <meta property="fc:frame:image" content={`${baseURL}/api/frames/subscribe/fund-dash?${qs.stringify({ fid: referrer })}`} />
        <meta property="fc:frame:image:aspect_ratio" content="1.91:1" />
        <meta property="fc:frame:button:1" content='Boost' />
        <meta property="fc:frame:button:1:action" content="post" />
        <meta property="fc:frame:button:1:target" content={`${baseURL}/api/frames/subscribe/fund?fund=boost`} />
        <meta property="fc:frame:button:2" content='Validate' />
        <meta property="fc:frame:button:2:action" content="post" />
        <meta property="fc:frame:button:2:target" content={`${baseURL}/api/frames/subscribe/fund?fund=validate`} />
        {/* <meta property="fc:frame:button:3" content='Accelerated' />
        <meta property="fc:frame:button:3:action" content="post" />
        <meta property="fc:frame:button:3:target" content={`${baseURL}/api/frames/subscribe/fund?fund=accelerated`} /> */}
        <meta property="fc:frame:button:3" content='Login /impact' />
        <meta property="fc:frame:button:3:action" content="link" />
        <meta property="fc:frame:button:3:target" content={`${baseURL}?${qs.stringify({ referrer, autoFund: 'true' })}`} />
