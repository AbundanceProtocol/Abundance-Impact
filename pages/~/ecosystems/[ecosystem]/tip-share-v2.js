  ...
  return (
    ...
    {queryData && (
      <Head>
        ...
        <meta property="fc:frame:button:4:target" content={`https://farcaster.xyz/~/composer-action?view=prompt&url=https%3A%2F%2Fimpact.abundance.id%2Fapi%2Fmini-app%2Fcurator%3Ffid%3D${tipperFid}%26id%3D${id}%26app%3Dmini`} />
