    ...
    >
      {queryData && (
        <Head>
          ...
          <meta property="fc:frame:button:2" content={"Auto-Fund >"} />
          <meta property="fc:frame:button:2:action" content="post" />
          <meta
            property="fc:frame:button:2:target"
          ...
          <meta property="fc:frame:button:3" content={"Explore"} />
          ...
          <meta property="fc:frame:button:4:target" content={`${baseURL}?${qs.stringify({ referrer: tipperFid })}`} />
