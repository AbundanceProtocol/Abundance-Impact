...
export default function Tips({fid, ecosystem}) {
  ...
  const initFrame = 
    {
      version: "vNext",
      title: "Multi-Tip",
      image: `${baseURL}/api/frames/reward/frame?${qs.stringify({ fid })}`,
      ...
      buttons: [
        {
          ...
          title: "My Reward",
          action_type: "post",
          target: `${baseURL}/api/frames/reward/stats`
        },
        {
          index: 2,
          title: "Login /impact",
  ...
  useEffect(() => {
    ...
    updatedFrameData.buttons[0].target = `${baseURL}/api/frames/reward/stats`

    updatedFrameData.buttons[1].target = `${baseURL}?${qs.stringify({  referrer: fid })}`

    // updatedFrameData.buttons[2].target = `${baseURL}/api/frames/tip/auto-tip?${qs.stringify({ time, curators, eco, ecosystem })}`

    updatedFrameData.image = `${baseURL}/api/frames/reward/frame?${qs.stringify({ fid })}`
  ...
  return (
    ...
    {queryData && (
      <Head>
        ...
        <meta property="og:title" content="Impact Creator Rewards" />
        <meta property='og:image' content={`${baseURL}/api/frames/reward/frame?${qs.stringify({ fid })}`} />
        <meta property="fc:frame" content="vNext" />
        <meta property="fc:frame:image" content={`${baseURL}/api/frames/reward/frame?${qs.stringify({ fid })}`} />
        <meta property="fc:frame:image:aspect_ratio" content="1.91:1" />
        <meta property="fc:frame:button:1" content='My Reward' />
        <meta property="fc:frame:button:1:action" content="post" />
        <meta property="fc:frame:button:1:target" content={`${baseURL}/api/frames/reward/stats`} />

        <meta property="fc:frame:button:2" content='Login /impact' />
        <meta property="fc:frame:button:2:action" content="link" />
        <meta property="fc:frame:button:2:target" content={`${baseURL}?${qs.stringify({ referrer: fid })}`} />
