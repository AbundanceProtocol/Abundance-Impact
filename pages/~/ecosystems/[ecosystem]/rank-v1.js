...
export default function Tips({eco, ecosystem, referrer, id}) {
  ...
  const initFrame = 
    {
      version: "vNext",
      title: "Multi-Tip",
      image: `${baseURL}/api/frames/rank/frame?${qs.stringify({ id })}`,
      ...
      buttons: [
        {
          ...
          title: "My Stats",
          action_type: "post",
          target: `${baseURL}/api/frames/rank/stats`
        },
        {
          index: 2,
          title: "Login /impact",
  ...
  useEffect(() => {
    ...
    updatedFrameData.buttons[0].target = `${baseURL}/api/frames/rank/stats?${qs.stringify({ eco, ecosystem, referrer })}`

    updatedFrameData.buttons[1].target = `${baseURL}?${qs.stringify({ eco, referrer })}`

    // updatedFrameData.buttons[2].target = `${baseURL}/api/frames/tip/auto-tip?${qs.stringify({ time, curators, eco, ecosystem })}`

    updatedFrameData.image = `${baseURL}/api/frames/rank/frame?${qs.stringify({ id })}`
  ...
  return (
    ...
    {queryData && (
      <Head>
        ...
        <meta property='og:image' content={`${baseURL}/api/frames/rank/frame?${qs.stringify({ id })}`} />
        <meta property="fc:frame" content="vNext" />
        <meta property="fc:frame:image" content={`${baseURL}/api/frames/rank/frame?${qs.stringify({ id })}`} />
        <meta property="fc:frame:image:aspect_ratio" content="1:1" />
        <meta property="fc:frame:button:1" content='My Stats' />
        <meta property="fc:frame:button:1:action" content="post" />
        <meta property="fc:frame:button:1:target" content={`${baseURL}/api/frames/rank/stats?${qs.stringify({ eco, ecosystem, referrer })}`} />

        <meta property="fc:frame:button:2" content='Login /impact' />
        <meta property="fc:frame:button:2:action" content="link" />
        <meta property="fc:frame:button:2:target" content={`${baseURL}?${qs.stringify({ eco, referrer })}`} />
...
export async function getServerSideProps(context) {
  ...
  const { id, fid, referrer, eco } = query;
