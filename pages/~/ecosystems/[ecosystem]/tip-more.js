  ...
  return (
    ...
    {queryData && (
      <Head>
        ...
        <meta property="fc:frame:button:3:target" content={`${baseURL}/api/frames/tip/refresh?${qs.stringify({    
          time, curators, eco, ecosystem })}`} />
        <meta property="fc:frame:button:4" content={`What's /impact?`} />
        <meta property="fc:frame:button:4:action" content="link" />
        <meta property="fc:frame:button:4:target" content={`https://warpcast.com/abundance/0x43ddd672`} />
