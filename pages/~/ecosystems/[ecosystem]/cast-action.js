...
export default function Tips({eco, ecosystem}) {
  ...
  const shareText = `I just became a curator on /impact!\n\nLet's accelerate Farcaster's attention > creation transition 👇`

  let shareUrl = `https://impact.abundance.id/~/ecosystems/${ecosystem}/cast-action?${qs.stringify({eco})}`
  ...
  const initFrame = 
    {
      ...
      image: `https://wrpcd.net/cdn-cgi/imagedelivery/BXluQx4ige9GuW0Ia56BHw/56c06918-49d8-4f31-4667-e26d46b8dc00/rectcontain3`,
      ...
      buttons: [
        {
          ...
          title: "Login",
          action_type: "link",
          target: `https://impact.abundance.id/?${qs.stringify({ eco })}`
        },
        {
          index: 2,
          title: "Share",
  ...
  // useEffect(() => {
    ...
    // updatedFrameData.buttons[1].target = `${baseURL}/api/frames/console/tip-tip?${qs.stringify({    
    //   time, curators, eco, ecosystem, start: true
    // })}`
    ...
    // updatedFrameData.image = `https://wrpcd.net/cdn-cgi/imagedelivery/BXluQx4ige9GuW0Ia56BHw/56c06918-49d8-4f31-4667-e26d46b8dc00/rectcontain3`
  ...
  return (
    ...
    {queryData && (
      <Head>
        ...
        <meta property='og:image' content={`https://wrpcd.net/cdn-cgi/imagedelivery/BXluQx4ige9GuW0Ia56BHw/56c06918-49d8-4f31-4667-e26d46b8dc00/rectcontain3`} />
        <meta property="fc:frame" content="vNext" />
        <meta property="fc:frame:image" content={`https://wrpcd.net/cdn-cgi/imagedelivery/BXluQx4ige9GuW0Ia56BHw/56c06918-49d8-4f31-4667-e26d46b8dc00/rectcontain3`} />
        <meta property="fc:frame:image:aspect_ratio" content="1:1" />
        <meta property="fc:frame:button:1" content='Login' />
        <meta property="fc:frame:button:1:action" content="link" />
        <meta property="fc:frame:button:1:target" content={`https://impact.abundance.id/?${qs.stringify({ eco })}`} />
