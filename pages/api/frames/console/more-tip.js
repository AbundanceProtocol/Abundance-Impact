...
export default async function handler(req, res) {
  ...
  if (req.method !== 'POST') {
    ...
    <meta property="fc:frame:button:4:target" content='https://impact.abundance.id/api/frames/console/tipper?${qs.stringify({ iB, qB, qT, author, iA, qA, ecosystem: ec, login, pt, cu, impact, quality: ql, cI, hash, handle })}' />`
