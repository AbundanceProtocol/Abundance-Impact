...
export default async function handler(req, res) {
  ...
  if (req.method === 'POST') {
    ...
    let balanceImg = `${baseURL}/api/frames/console/balance-tip?${qs.stringify({ iB: impactBalance, qB: qualityBalance, qT: qualityTotal, author, iA: impactAllowance, qA: qualityAllowance, ecosystem: ecoName, login: needLogin, pt: points, cu: curator })}`
    ...
    if (needLogin == true) {
      ...
      <meta property="fc:frame:button:2:target" content='https://impact.abundance.id/api/frames/console/refresh-tip?${qs.stringify({ pt: points })}' />`
      ...
      <meta property="fc:frame:button:1:target" content='https://impact.abundance.id/api/frames/console/impact-tip?${qs.stringify({ addImpact: 1, iB: impactBalance, qB: qualityBalance, qT: qualityTotal, author, iA: impactAllowance, qA: qualityAllowance, ec: ecoName, login: needLogin, pt: points, cu: curator, impact, ql: quality, cI: castImpact, hash: castHash })}' />`
      button2 = `<meta property="fc:frame:button:2" content='+5 ${points}' />
      <meta property="fc:frame:button:2:action" content="post" />
      <meta property="fc:frame:button:2:target" content='https://impact.abundance.id/api/frames/console/impact-tip?${qs.stringify({ addImpact: 5, iB: impactBalance, qB: qualityBalance, qT: qualityTotal, author, iA: impactAllowance, qA: qualityAllowance, ec: ecoName, login: needLogin, pt: points, cu: curator, impact, ql: quality, cI: castImpact, hash: castHash })}' />`
