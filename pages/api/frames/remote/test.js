...
export default async function handler(req, res) {
  ...
  if (req.method !== 'POST') {
    ...
    if (login == true) {
      ...
      <meta property="fc:frame:button:2:target" content='https://impact.abundance.id/api/remote/test?${qs.stringify({ iB, qB, qT, author, iA, qA, ecosystem, login, pt, cu, impact, quality, cI, hash })}' />`
    } else if (parseInt(cI) == 0 && parseInt(impact) == 0 && parseInt(quality) == 0) {
      console.log('2')

      button1 = `<meta property="fc:frame:button:1" content='+1 ${pt}' />
      <meta property="fc:frame:button:1:action" content="post" />
      <meta property="fc:frame:button:1:target" content='https://impact.abundance.id/api/remote/test?${qs.stringify({ iB, qB, qT, author, iA, qA, ecosystem, login, pt, cu, impact, quality, cI, hash })}' />`
      button2 = `<meta property="fc:frame:button:2" content='+5 ${pt}' />
      <meta property="fc:frame:button:2:action" content="post" />
      <meta property="fc:frame:button:2:target" content='https://impact.abundance.id/api/remote/test?${qs.stringify({ iB, qB, qT, author, iA, qA, ecosystem, login, pt, cu, impact, quality, cI, hash })}' />`
      button3 = `<meta property="fc:frame:button:3" content='More >' />
      <meta property="fc:frame:button:3:action" content="post" />
      <meta property="fc:frame:button:3:target" content='https://impact.abundance.id/api/remote/test?${qs.stringify({ iB, qB, qT, author, iA, qA, ecosystem, login, pt, cu, impact, quality, cI, hash })}' />`
      ...
      <meta property="fc:frame:button:4:target" content='https://impact.abundance.id/api/remote/test?${qs.stringify({ iB, qB, qT, author, iA, qA, ecosystem, login, pt, cu, impact, quality, cI, hash })}' />`
