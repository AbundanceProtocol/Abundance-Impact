    ...
    try {
      ...
      if (fundSchedule) {
        ...
        async function updateSchedule(fid) {
          try {
            await connectToDatabase();
            let updated = await ScheduleTip.findOneAndUpdate({ fid: Number(fid) }, { active_cron: false }, { new: true, select: '-uuid' });
      ...
      if (schedId) {
        ...
        circlesImg = `${baseURL}/api/frames/fund/fund-dash?${qs.stringify({ fid, fund: 'off' })}`
        ...
        let metatags = `
        <meta name="fc:frame:button:1" content="Standard">
        <meta name="fc:frame:button:1:action" content="post">
        <meta name="fc:frame:button:1:target" content="${baseURL}/api/frames/fund/fund?fund=standard" />
        <meta name="fc:frame:button:2" content="Optimized">
        <meta name="fc:frame:button:2:action" content="post">
        <meta name="fc:frame:button:2:target" content="${baseURL}/api/frames/fund/fund?fund=optimized" />
        <meta name="fc:frame:button:3" content="Accelerated">
        <meta name="fc:frame:button:3:action" content="post">
        <meta name="fc:frame:button:3:target" content="${baseURL}/api/frames/fund/fund?fund=accelerated" />
        <meta name="fc:frame:button:4" content="Login /impact">
        <meta name="fc:frame:button:4:action" content="link">
        <meta name="fc:frame:button:4:target" content="${loginUrl}" />
