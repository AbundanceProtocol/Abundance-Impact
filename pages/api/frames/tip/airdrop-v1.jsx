  ...
  try {
    ...
    async function getUser(fid) {
      try {
        ...
        await connectToDatabase();
        const userFunding = await CreatorFund.findOne({fid: fid}).select('degen').exec();
        ...
        <div style={{
          ...
          alignItems: 'center', 
            ...
            {threshold && (
              ...
              <div style={{display: 'flex', textAlign: 'center', color: '#def', fontSize: '32px', margin: '15px 0 0 0', fontWeight: '700'}}>Creator Rewards</div>
