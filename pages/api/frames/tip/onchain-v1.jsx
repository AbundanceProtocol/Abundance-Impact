        ...
        <div style={{
          ...
          alignItems: 'center', 
            ...
            {threshold && (
              ...
              <div style={{display: 'flex', textAlign: 'center', color: '#def', fontSize: '40px', margin: '0', fontWeight: '700', margin: '30px 0 0 0'}}>${sum > 1 ? sum.toFixed(2) : sum.toFixed(3)}</div>
              <div style={{display: 'flex', textAlign: 'center', color: '#def', fontSize: '30px', margin: '10px 0 0 0', fontWeight: '700'}}>Onchain Rewards</div>
