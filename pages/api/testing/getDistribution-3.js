        ...
        try {
          ...
          for (const set of funds) {
            ...
            if (set?.curators?.length > 0) {
              ...
              let uniqueTargetCastHashes = await Impact.distinct('target_cast_hash', { curator_fid: { $in: curators }, impact_points: { $gt: 0 }, createdAt: { $gte: last60Days } });
