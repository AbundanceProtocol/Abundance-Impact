...
const Ecoboard = () => {
  ...
  return (
    (router.route == '/~/ecosystems/[ecosystem]') &&  (
      <div style={{margin: '58px 0px 12px 20px', backgroundColor: '#334455ee', width: '380px', borderRadius: '20px', padding: '32px', border: '0px solid #678', color: '#fff', fontWeight: '700', alignItems:' center', fontSize: '20px'}}>
        <div className='flex-row' style={{alignItems: 'center', gap: '0.5rem', marginBottom: '10px'}}>
