...
const BottomMenu = () => {
  ...
  return (
    isMobile ? (
      <>
        {router.route !== '/~/studio/multi-tip-compose' && (<div ref={ref1} className='flex-row' style={{position: 'fixed', bottom: 0, backgroundColor: '#1D3244cc', height: '46px', width: `100%`, borderRadius: '0px', padding: '0', border: '0px solid #678', boxSizing: 'border-box'}}>
