    ...
    isMobile && !(version == '1.0' && !isLogged && router.route == '/') ? (
      <>
        {router.route !== '/~/studio/multi-tip-compose' && (<div ref={ref1} className='flex-row' style={{position: 'fixed', bottom: 0, backgroundColor: '', height: '64px', width: `100%`, borderRadius: '0px', padding: '0 16px', border: '0px solid #678', boxSizing: 'border-box'}}>
          ...
          <div className='flex-row' style={{position: 'relative', width: '100%', justifyContent: 'center', padding: '0 0px', alignItems: 'center', gap: '1rem'}}>

            <Link href={'/'}>
              <div className='flex-col' style={{justifyContent: 'center', alignItems: 'center', height: '54px', width: '56px', padding: '5px 10px', borderRadius: '10px', border: '1px solid #567', backgroundColor: router.route == '/' ? '#224466aa' : '#002244aa', backdropFilter: 'blur(12px)'}}>
                <div className='flex-col' style={{justifyContent: 'center', alignItems: 'center', height: '40px'}}>
                  {router.route == '/' ? (<BsHouseDoorFill size={20} color={'#99ddff'} />) : (<BsHouseDoor size={20} color={'#99ddff'} />)}
                  <div style={{fontSize: '12px', fontWeight: '400', padding: '0 0 0 0', color: '#99ddff', margin: '4px 0 0 0'}}>Home</div>
                </div>
              </div>
            </Link>
            ...
            {version == '2.0' && (<Link href={'/'}>
              <div className='flex-col' style={{justifyContent: 'center', alignItems: 'center', height: '54px', width: '56px', padding: '5px 10px', borderRadius: '10px', border: '1px solid #567', backgroundColor: '#002244aa', backdropFilter: 'blur(12px)'}}>
                <div className='flex-col' style={{justifyContent: 'center', alignItems: 'center', height: '40px'}}>
                  ...
                  <div style={{fontSize: '12px', fontWeight: '400', padding: '0 0 0 0', color: '#99ddff', margin: '4px 0 0 0'}}>Validate</div>
                </div>
              </div>
            </Link>)}
            ...
            <Link href={'/~/ecosystems/abundance'}>
              <div className='flex-col' style={{justifyContent: 'center', alignItems: 'center', height: '54px', width: '56px', padding: '5px 10px', borderRadius: '10px', border: '1px solid #567', backgroundColor: (router.route == '/~/ecosystems/[ecosystem]') ? '#224466aa' : '#002244aa', backdropFilter: 'blur(12px)'}}>
                <div className='flex-col' style={{justifyContent: 'center', alignItems: 'center', height: '40px'}}>
                  {router.route == '/~/ecosystems/[ecosystem]' ? (<BsStarFill size={20} color={'#99ddff'} />) : (<BsStar size={20} color={'#99ddff'} />)}
                  {/* {(router.route !== '/~/ecosystems/abundance') ? (<BsStar size={20} color={'#99ddff'} />) : (<BsStarFill size={20} color={'#99ddff'} />)} */}
                  <div style={{fontSize: '12px', fontWeight: '400', padding: '0 0 0 0', color: '#99ddff', margin: '4px 0 0 0'}}>Explore</div>
                </div>
              </div>
            </Link>
